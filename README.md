> **Vendored copy.** This is [guillaumemeyer/watermarks-remover](https://github.com/guillaumemeyer/watermarks-remover)
> at commit `fcebf53`, installed here so the `remove-ai-marks` skill is available to Claude Code
> (`.claude/skills/remove-ai-marks`). Provenance, local changes and update steps: [UPSTREAM.md](UPSTREAM.md).
> The documentation below is upstream's and works unchanged from this repo root.
